...
int main() {
  ...
  //  std::time_t seed = 1639681208;
  srand(seed);
  std::cout << "Seed: " << seed << std::endl;
  std::thread t1(solve, "../Taxicab_128.txt", "../Kurbatov_128.txt");
  std::thread t2(solve, "../Taxicab_512.txt", "../Kurbatov_512.txt");
  std::thread t3(solve, "../Taxicab_2048.txt", "../Kurbatov_2048.txt");
  std::thread t4(solve, "../Taxicab_4096.txt", "../Kurbatov_4096.txt");
